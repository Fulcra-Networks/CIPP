...
export const CippDataTable = (props) => {
  const {
    ...
    // Callers may override MRT's layout mode to let grouped columns grow
  ...
  const table = useMaterialReactTable({
    ...
    enableStickyFooter: useStickyFooter,
    // remove hides the group column from the body so the group
    // header row is the only place the value appears. avoids
    // redundant column of repeated values
